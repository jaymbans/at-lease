...
function EditListing() {
  ...
  // useEffect if the form is not the user's
  ...
  // useEffect to populate the form visibly
  useEffect(() => {
    setLoading(true);
    ...
    const fetchListing = async () => {
      ...
      } else { //redirect to homepage if the listing does not exist
        navigate('/');
        toast.error('Failed to retrieve listing data')
      }
    }
    fetchListing();
  }, [navigate, params.listingId])

  // useEffect to populate the form via state
  useEffect(() => {
    if (isMounted) {
  ...
  return (
    <div className='profile'>
      <header>
        <p className="pageHeader">Edit your home!</p>
      </header>
      <main>
